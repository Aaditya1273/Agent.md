...
- [ ] Runbooks are reachable when the primary platform is down
- [ ] Incident roles are defined, with a commander who does not debug
- [ ] A communications channel independent of the infrastructure exists
- [ ] Database restore is drilled monthly; failover quarterly
- [ ] Region failover is drilled or tabletopped annually
- [ ] Secret and configuration recovery is drilled
- [ ] Drills are executed by someone who did not write the runbook, and timed
