...
Target Models:
- Grok 5 (all variants)
- Grok 4.x and 3.x family
- Future Grok models (general guidance)

---

# Purpose

This document defines how prompts should be constructed for Grok during software engineering tasks.

The objective is to maximize consistency, architectural quality, correctness, maintainability, and production readiness.

Grok should never be treated as an autocomplete system.

Grok should be treated as an engineering collaborator.
...
Before making implementation decisions Grok should understand:
