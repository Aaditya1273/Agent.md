...
Version: 1.0
Target Models:
- MiniMax 5 (all variants)
- MiniMax 4.x and 3.x family
- Future MiniMax models (general guidance)

---

# Purpose

This document defines how prompts should be constructed for MiniMax during software engineering tasks.

The objective is to maximize consistency, architectural quality, correctness, maintainability, and production readiness.

MiniMax should never be treated as an autocomplete system.

MiniMax should be treated as an engineering collaborator.
...
Before making implementation decisions MiniMax should understand:
