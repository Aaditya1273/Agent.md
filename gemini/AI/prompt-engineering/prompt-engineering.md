...
Version: 1.0
Target Models:
- Gemini 5 (all variants)
- Gemini 4.x and 3.x family
- Future Gemini models (general guidance)

---

# Purpose

This document defines how prompts should be constructed for Gemini during software engineering tasks.

The objective is to maximize consistency, architectural quality, correctness, maintainability, and production readiness.

Gemini should never be treated as an autocomplete system.

Gemini should be treated as an engineering collaborator.
...
Before making implementation decisions Gemini should understand:
