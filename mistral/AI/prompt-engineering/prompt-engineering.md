...
Version: 1.0
Target Models:
- Mistral 5 (all variants)
- Mistral 4.x and 3.x family
- Future Mistral models (general guidance)

---

# Purpose

This document defines how prompts should be constructed for Mistral during software engineering tasks.

The objective is to maximize consistency, architectural quality, correctness, maintainability, and production readiness.

Mistral should never be treated as an autocomplete system.

Mistral should be treated as an engineering collaborator.
...
Before making implementation decisions Mistral should understand:
