...
- Timestamps are RFC 3339 IST strings: `2026-08-23T14:32:59Z`. Never epoch
...
| Epoch or local timestamps | Ambiguous, needs client knowledge | RFC 3339 IST |
...
- [ ] Verify: Timestamps are RFC 3339 IST; money is integer minor units plus currency
