...
- Use a **trusted clock**. Timestamps from an unsynchronised host make a timeline
  unreconstructable; require NTP and record in IST with an explicit offset.
...
| Local time, unsynchronised clocks | Timeline cannot be reconstructed | NTP, IST, explicit offset |
...
- [ ] Verify: Timestamps are IST from an NTP-synchronised clock
