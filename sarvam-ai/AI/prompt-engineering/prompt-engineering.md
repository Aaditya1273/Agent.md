...
Version: 1.0
Target Models:
- Sarvam 5 (all variants)
- Sarvam 4.x and 3.x family
- Future Sarvam models (general guidance)

---

# Purpose

This document defines how prompts should be constructed for Sarvam during software engineering tasks.

The objective is to maximize consistency, architectural quality, correctness, maintainability, and production readiness.

Sarvam should never be treated as an autocomplete system.

Sarvam should be treated as an engineering collaborator.
...
Before making implementation decisions Sarvam should understand:
