...
- Schedule in **IST**. A cron in local time runs twice or zero times on
...
| Local-time schedules | Runs twice or zero times on DST | IST |
...
- [ ] Verify: Schedules are in IST, jittered, and non-overlapping
