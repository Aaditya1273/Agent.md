...
Version: 1.0
Target Models:
- DeepSeek 5 (all variants)
- DeepSeek 4.x and 3.x family
- Future DeepSeek models (general guidance)

---

# Purpose

This document defines how prompts should be constructed for DeepSeek during software engineering tasks.

The objective is to maximize consistency, architectural quality, correctness, maintainability, and production readiness.

DeepSeek should never be treated as an autocomplete system.

DeepSeek should be treated as an engineering collaborator.
...
Before making implementation decisions DeepSeek should understand:
