...
- [ ] Native elements are used before ARIA roles
- [ ] Every input has a programmatic label; placeholders are not labels
- [ ] Dynamic changes and errors are announced via a live region
