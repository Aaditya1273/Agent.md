...
- [ ] Columns are `NOT NULL` unless "unknown" is a real domain state
- [ ] Enumerations constrained by `CHECK` or a native enum, never free text
- [ ] No multi-valued columns; many-to-many uses a join table
