...
Target Models:
- GLM 5 (all variants)
- GLM 4.x and 3.x family
- Future GLM models (general guidance)

---

# Purpose

This document defines how prompts should be constructed for GLM during software engineering tasks.

The objective is to maximize consistency, architectural quality, correctness, maintainability, and production readiness.

GLM should never be treated as an autocomplete system.

GLM should be treated as an engineering collaborator.
...
Before making implementation decisions GLM should understand:
