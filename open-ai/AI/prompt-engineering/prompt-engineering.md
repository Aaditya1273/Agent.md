...
Version: 1.0
Target Models:
- ChatGPT 5 (all variants)
- ChatGPT 4.x and 3.x family
- Future ChatGPT models (general guidance)

---

# Purpose

This document defines how prompts should be constructed for ChatGPT during software engineering tasks.

The objective is to maximize consistency, architectural quality, correctness, maintainability, and production readiness.

ChatGPT should never be treated as an autocomplete system.

ChatGPT should be treated as an engineering collaborator.
...
Before making implementation decisions ChatGPT should understand:
