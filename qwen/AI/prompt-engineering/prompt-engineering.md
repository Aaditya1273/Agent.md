...
Target Models:
- Qwen 5 (all variants)
- Qwen 4.x and 3.x family
- Future Qwen models (general guidance)

---

# Purpose

This document defines how prompts should be constructed for Qwen during software engineering tasks.

The objective is to maximize consistency, architectural quality, correctness, maintainability, and production readiness.

Qwen should never be treated as an autocomplete system.

Qwen should be treated as an engineering collaborator.
...
Before making implementation decisions Qwen should understand:
