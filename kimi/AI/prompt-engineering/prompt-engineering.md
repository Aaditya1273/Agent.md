...
Target Models:
- Kimi 5 (all variants)
- Kimi 4.x and 3.x family
- Future Kimi models (general guidance)

---

# Purpose

This document defines how prompts should be constructed for Kimi during software engineering tasks.

The objective is to maximize consistency, architectural quality, correctness, maintainability, and production readiness.

Kimi should never be treated as an autocomplete system.

Kimi should be treated as an engineering collaborator.
...
Before making implementation decisions Kimi should understand:
